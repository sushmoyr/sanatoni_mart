    ...
    return (
        <GuestLayout>
            ...
            <div className="p-8">
                ...
                {status && (
                    <div className="bg-success-50 border border-success-200 text-success-700 px-4 py-3 rounded-lg text-sm mb-6">
                        {status}
                    </div>
                )}
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-semantic-border rounded"
                            />
