...
export default function Create({ subscriber_count, recent_subscribers }: Props) {
    const [isPreviewMode, setIsPreviewMode] = useState(false);
    const [isSaving, setIsSaving] = useState(false);
    const contentRef = useRef<HTMLTextAreaElement>(null);

    const { data, setData, post, processing, errors, reset } = useForm<NewsletterData>({
        subject: '',
        content: '',
        preheader: '',
        schedule_type: 'now',
    ...
    const handleSaveDraft = () => {
        ...
        router.post(route('admin.newsletters.store'), {
            ...data,
            status: 'draft',
        }, {
            onSuccess: () => {
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                ...
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        <h1 className="text-2xl font-semibold leading-6 text-gray-900">Create Newsletter</h1>
                        <p className="mt-2 text-sm text-gray-700">
                            Create and send a newsletter to your {subscriber_count} subscribers
                        </p>
                    </div>
                </div>
                            ...
                            <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                                <div className="px-4 py-6 sm:p-8">
                                    <div className="grid max-w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div className="sm:col-span-6">
                                            <InputLabel value="Email Template" />
                                ...
                                <div className="flex items-center justify-between gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                                    ...
                                    <div className="flex gap-x-3">
                                        ...
                                        >
                                            {processing 
                                                ? (data.schedule_type === 'now' ? 'Sending...' : 'Scheduling...') 
                                                : (data.schedule_type === 'now' ? 'Send Newsletter' : 'Schedule Newsletter')
                                            }
                                        </PrimaryButton>
                                    </div>
                                </div>
